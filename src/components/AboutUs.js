...
function AboutUs (){
    return(
        <div className="about-container">
            ...
            <p>Somos una empresa ubicada en Córdoba, Argentina con una vasta experiencia en instalaciones eléctricas con más de 20 años de trabajos y obras en el rubro eléctrico</p>
            <p>Contamos con un grup ode profesionales, infraestructuras y materiales de primeras marcas que nos permiten desarrollar proyectos confiables y de calidad, con flexibilidad para adaptarse a los requerimentos de cada uno de nuestros clientes. A su vez, la capacitación constante a nuestra mano de obra, nos permite mantener la competitividad de nuestros servicios.
            Abordando las tareas con capacidad operativa, preparacion tecnica y avanzadas herramientas tecnologicas, ofrecemos amplio abanico de respuestas para cada problematica que se presente en el desarrollo de los proyectos afrontados
            </p>
